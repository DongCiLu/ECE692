...
flags.DEFINE_string('dec_act_func', 'none', 'Activation function for the decoder. ["sigmoid", "tanh", "none", "relu"]')
...
assert FLAGS.dec_act_func in ['sigmoid', 'tanh', 'none', 'relu']
assert FLAGS.corr_type in ['masking', 'salt_and_pepper', 'none', 'gaussian']
